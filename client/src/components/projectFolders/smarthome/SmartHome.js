    ...
    render(){
          ...
          <div>
            ...
            <div className="portfolio-content container">
              {/* <Portfolio/> */}
              <div className="row">
              <img data-aos="fade-right" data-aos-duration="500" src={portfolio2} alt="Images" className="m-auto d-block col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 pr-5 pb-4" />
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 pr-5 pb-4" data-aos="fade-left" data-aos-duration="500">
                ...
                <div className="my-4 text-center row my-links">
                  <a className="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" href="https://github.com/Pearly-choong/zoneSmartHomeAutomation" target="_blank" rel="noopener noreferrer"><span><i className="fab fa-github pr-2"></i></span>Code in Github</a>
                  {/* <p className="text-muted col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">Live Site Coming Soon</p> */}
                  <a className="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" href="https://pearly-choong.github.io/zoneSmartHomeAutomation/" target="_blank" rel="noopener noreferrer"><span><i className="fab fa-chrome pr-2"></i></span>Live Site</a>
                </div>
              </div>
              </div>
                ...
                <div className="my-3 text-center row my-links">
                  <a className="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4" href="https://drive.google.com/file/d/1s8mv3NcjJitT15AV3bOHbycnE9B2dMqY/view?usp=sharing" target="_blank" rel="noopener noreferrer"><span><i className="far fa-file-pdf pr-2"></i></span>Read Full Documentation</a>
                </div>
